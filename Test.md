...
Semanalmente o gerente da Fifa solicita a média de gols dos times mandantes. Como você faria, em SQL, para salvar ou automatizar essa query? Envie-nos seu código.
Apresente análises descritivas destes dados utilizando CTE.
